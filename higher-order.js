...
let evenNumbers = mixedNumbers.filter(index => index%2 === 0); // = mixedNumbers.filter(/* Provide Your Callback Here */)
...
let postTaxPrices = prices.map(index => index * 1.07); // = prices.map(/* Provide Your Callback Here );
